...
| exotic_alpha | quinella | exacta | trio | 的中/回収 |
|---|---|---|---|---|
| なし（従来 Harville） | 66点 | 15点 | 30点 | **全0% / -0%** |
| 0.5 | 4点 | — | 2点 | 全0% / -0% |
| 0.7 | 20点 | 5点 | 11点 | 全0% / -0% |
| 0.9 | 46点 | 11点 | 22点 | 全0% / -0% |

- **どの α でも exotic 的中率 0.0%・回収率 -0.0%**。市場ブレンドは推奨点数を変える（市場重みが増えるほど
...
- **Phase 1**: #194 の主目的（複勝系の校正）は達成できるが、買い目予算が乗る複勝の回収率が悪化したため
  ...
  楽観アーティファクト（小頭数の複勝は採用確率 show と的中定義の非対称で歪む、既知）を割り引くと
  本番化を正当化できない。
