...
「ROI≥100% で張れる鞍が極端に少ない」課題への対策として、+EV が集中する馬連に券種を絞り、◎1頭軸ながしの相手のうち馬連 model EV≥θ（θ=1.0/1.2/1.5）の点だけを買う案。配分（flat/weighted）・オッズ上限（cap=∞/50/30）も掃引した（動機: 2026-06-27 の手作業で「フルポートフォリオ ROI≥100% は 2 鞍だが濃い +EV 馬連は約 14 鞍」）。
