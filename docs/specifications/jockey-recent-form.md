...
- [ ] バックテスト sweep 後にメトリクスを記録し ADR 0037 として棄却または採用を記録する（次の ADR 番号は 0037。0035=recent_form_weight #217 / 0036=trend-n #220 で消費済み。作成時に最新の空き番号を再確認すること）
...
- ADR 0037（未作成・backtest sweep 後に騎手直近フォームの棄却または採用を記録予定）
