...
/// 比較, 2026-03-28〜05-31 / 144 レース, #81 後ロジック）で再検証した。trainer 項は 0.0（無効）比で
/// 校正が明確に改善（LogLoss 単勝 0.60→0.40）し、0.5/1.0/2.0 は拮抗、1.0 が LogLoss 単勝・Brier 複勝で
/// 最良だったため 1.0 を採用（ADR 0012）。
