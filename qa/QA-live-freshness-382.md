...
> 質問票+回答（[qa/README.md](README.md)）。一次資料は [docs-original/382-live-server-now.md](../docs-original/382-live-server-now.md)。
> 回答済みの本票は [knowledge/live-freshness-calibration.md](../knowledge/live-freshness-calibration.md) に蒸留した。
