...
> 質問票+回答（[qa/README.md](README.md)）。一次資料は [docs-original/401-analyze-partial-match.md](../docs-original/401-analyze-partial-match.md)。
> 回答済みの本票は実装後 [knowledge/analyze-search-and-state.md](../knowledge/analyze-search-and-state.md) に蒸留する。
