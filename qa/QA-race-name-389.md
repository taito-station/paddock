...
> 質問票+回答（[qa/README.md](README.md)）。一次資料は [docs-original/389-race-name.md](../docs-original/389-race-name.md)。
> 回答済みの本票は [knowledge/race-card-display-metadata.md](../knowledge/race-card-display-metadata.md) に蒸留した。
