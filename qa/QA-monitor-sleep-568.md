...
一次資料: [docs-original/568-monitor-sleep-gap.md](../docs-original/568-monitor-sleep-gap.md)
...
- 反映先: knowledge/monitor-loop-sleep-resilience.md
...
- 反映先: knowledge/monitor-loop-sleep-resilience.md / ADR 0072
...
- 反映先: knowledge/monitor-loop-sleep-resilience.md / ADR 0072 / deployments/launchd/README.md
...
- 反映先: knowledge/monitor-loop-sleep-resilience.md / ADR 0072 / keiba-start SKILL.md
...
- 観測/根拠: 3 巡目レビューで 2 名が指摘。`docs-original/568-monitor-sleep-gap.md` は冒頭で
...
- 反映先: docs-original/568-monitor-sleep-gap.md（注記を除去）
...
- 反映先: knowledge/monitor-loop-sleep-resilience.md / ADR 0072（却下した代替案）
