...
> 質問票+回答（[qa/README.md](README.md)）。一次資料は issue #410（全体レビュー 2026-07-15 由来）。
...
> **蒸留済み**（PR-B 完了・2026-07-17）: 確定知は [knowledge/app-bootstrap.md](../knowledge/app-bootstrap.md) へ。
