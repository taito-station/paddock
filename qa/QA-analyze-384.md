...
> 質問票+回答（[qa/README.md](README.md)）。一次資料は [docs-original/384-analyze.md](../docs-original/384-analyze.md)。
> 回答済みの本票を [knowledge/analyze-search-and-state.md](../knowledge/analyze-search-and-state.md) に蒸留した。
