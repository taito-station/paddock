...
一次資料: [docs-original/584-predict-watch-notification.md](../docs-original/584-predict-watch-notification.md)
...
- 反映先: knowledge/monitor-loop-sleep-resilience.md（規律 4・決定ログ #584）
...
- 反映先: knowledge/monitor-loop-sleep-resilience.md / CLAUDE.md
...
- 反映先: knowledge/monitor-loop-sleep-resilience.md（決定ログ #584 の影響）
...
- 反映先: knowledge/monitor-loop-sleep-resilience.md（規律 4）/ src/apps/predict-watch/src/notify.rs
